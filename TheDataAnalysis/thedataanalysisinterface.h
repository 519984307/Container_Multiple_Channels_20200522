#ifndef THEDATAANALYSISINTERFACE_H
#define THEDATAANALYSISINTERFACE_H
...
class TheDataAnalysisInterface : public QObject
{
    Q_OBJECT

public:
    virtual ~ TheDataAnalysisInterface(){}
...
#define TheDataAnalysisInterfaceIID "ZBY.ContainerServer.TheDataAnalysisInterface/1.0"
Q_DECLARE_INTERFACE(TheDataAnalysisInterface,TheDataAnalysisInterfaceIID);
