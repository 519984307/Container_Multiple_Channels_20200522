#ifndef CAPTUREIMAGES_SDK_HCNET_H
#define CAPTUREIMAGES_SDK_HCNET_H

#include "captureimages_sdk_hcnet_global.h"
#include "captureimages_sdk_hcnet_interface.h"
#include "HCNetSDK.h"

class CAPTUREIMAGES_SDK_HCNETSHARED_EXPORT CaptureImages_SDK_HCNET:public CaptureImages_SDK_HCNET_Interface
{
    Q_OBJECT
    Q_INTERFACES(CaptureImages_SDK_HCNET_Interface)
    Q_PLUGIN_METADATA(IID  CaptureImages_SDK_HCNET_InterfaceIID)

public:
    explicit CaptureImages_SDK_HCNET(QObject *parent=nullptr);
    ~CaptureImages_SDK_HCNET()Q_DECL_OVERRIDE;
...
#endif // CAPTUREIMAGES_SDK_HCNET_H
