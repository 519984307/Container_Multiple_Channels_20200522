#ifndef THELICENSEPLATEWTY_H
#define THELICENSEPLATEWTY_H

#include "TheLicensePlateWTY_global.h"
#include "ITheLicensePlateWTY.h"
#include "WTY_H/LPRCClientSDK.h"

class THELICENSEPLATEWTY_EXPORT TheLicensePlateWTY:public ITheLicensePlateWTY
{
    Q_OBJECT
    Q_INTERFACES(ITheLicensePlateWTY)
    Q_PLUGIN_METADATA(IID ITheLicensePlateWTY_IID)

public:
    TheLicensePlateWTY(QObject *parent=nullptr);
    ~TheLicensePlateWTY()Q_DECL_OVERRIDE;
...
private:
    ...
    static TheLicensePlateWTY *pThis;


};

#endif // THELICENSEPLATEWTY_H
