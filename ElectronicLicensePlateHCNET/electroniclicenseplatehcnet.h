#ifndef ELECTRONICLICENSEPLATEHCNET_H
#define ELECTRONICLICENSEPLATEHCNET_H
...
#include "ElectronicLicensePlateHCNET_global.h"
#include "HCNetSDK.h"
#include "licenseplateinterface.h"

class ELECTRONICLICENSEPLATEHCNET_EXPORT ElectronicLicensePlateHCNET:public LicensePlateInterface
{
    Q_OBJECT
...
public:
    ElectronicLicensePlateHCNET(QObject *parent=nullptr);
    ~ElectronicLicensePlateHCNET()Q_DECL_OVERRIDE;

    //static ElectronicLicensePlateHCNET *pThis;
...
//    ///
//    /// \brief imgNumber 抓拍图片编号
//    ///
//    int imgNumber;

//    ///
//    /// \brief imgTime 抓拍图片时间戳
//    ///
//    QString imgTime;
...
public:
    ...
    int camerID,imgFormat,channel;
    QString camerIP,imgPath;
    QMutex mutex;
    /*****************************
    * @brief:海康相机其它实现
    ******************************/
...
#endif // ELECTRONICLICENSEPLATEHCNET_H
