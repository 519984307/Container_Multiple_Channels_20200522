#ifndef INREAREDLOGIC_NJSB_H
#define INREAREDLOGIC_NJSB_H

#include "InrearedLogic_NJSB_global.h"
#include "infraredlogicinterface.h"

class INREAREDLOGIC_NJSB_EXPORT InrearedLogic_NJSB:public InfraredlogicInterface
{
    Q_OBJECT
...
public:
    explicit InrearedLogic_NJSB(QObject *parent = nullptr);
    ~InrearedLogic_NJSB() Q_DECL_OVERRIDE;
