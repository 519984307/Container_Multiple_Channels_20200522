...
QT_MOC_LITERAL(1, 10, 17), // "logicStatusSignal"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 4), // "int*"
QT_MOC_LITERAL(4, 34, 6), // "status"
QT_MOC_LITERAL(5, 41, 15) // "receiveDataSlot"

    },
    "TcpClient\0logicStatusSignal\0\0int*\0"
    "status\0receiveDataSlot"
};
...
void TcpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->receiveDataSlot(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpClient::logicStatusSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TcpClient::logicStatusSignal(int * _t1)
{
