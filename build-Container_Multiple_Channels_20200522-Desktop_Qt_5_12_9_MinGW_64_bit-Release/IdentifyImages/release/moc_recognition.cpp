...
#include "../../../Container_Multiple_Channels_20200522/IdentifyImages/recognition.h"
...
QT_MOC_LITERAL(1, 12, 23), // "recognitionResultSignal"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 6), // "result"
QT_MOC_LITERAL(4, 44, 7), // "imgName"
QT_MOC_LITERAL(5, 52, 9), // "imgNumber"
QT_MOC_LITERAL(6, 62, 13), // "messageSignal"
QT_MOC_LITERAL(7, 76, 4), // "type"
QT_MOC_LITERAL(8, 81, 3) // "msg"

    },
    "Recognition\0recognitionResultSignal\0"
    "\0result\0imgName\0imgNumber\0messageSignal\0"
    "type\0msg"
};
...
void Recognition::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->recognitionResultSignal((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< const int(*)>(_a[3]))); break;
        ...
        {
            using _t = void (Recognition::*)(const QString & , const QString & , const int & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Recognition::recognitionResultSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Recognition::*)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Recognition::messageSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Recognition::recognitionResultSignal(const QString & _t1, const QString & _t2, const int & _t3)
{
...
// SIGNAL 1
void Recognition::messageSignal(const QString & _t1, const QString & _t2)
{
