...
#include "../../../../Container_Multiple_Channels_20200522/Main/DataBase/filterdialog.h"
...
QT_MOC_LITERAL(1, 13, 17), // "signal_filterData"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 4), // "data"
QT_MOC_LITERAL(4, 37, 20), // "on_buttonBox_clicked"
QT_MOC_LITERAL(5, 58, 16), // "QAbstractButton*"
QT_MOC_LITERAL(6, 75, 6) // "button"

    },
    "FilterDialog\0signal_filterData\0\0data\0"
...
void FilterDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_filterData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FilterDialog::signal_filterData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FilterDialog::signal_filterData(QString _t1)
{
