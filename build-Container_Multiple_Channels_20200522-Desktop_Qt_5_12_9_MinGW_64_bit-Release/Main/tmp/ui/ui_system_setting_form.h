...
public:
    ...
    void setupUi(QWidget *System_Setting_Form)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 829, 836));
        ...
        comboBox_4 = new QComboBox(splitter_3);
        comboBox_4->addItem(QString());
        comboBox_4->addItem(QString());
        comboBox_4->setObjectName(QString::fromUtf8("comboBox_4"));
        splitter_3->addWidget(comboBox_4);
        ...
        checkBox_3 = new QCheckBox(Storage);
        checkBox_3->setObjectName(QString::fromUtf8("checkBox_3"));

        gridLayout_10->addWidget(checkBox_3, 0, 0, 1, 1);

        checkBox_4 = new QCheckBox(Storage);
        ...
        checkBox_8 = new QCheckBox(Storage);
        checkBox_8->setObjectName(QString::fromUtf8("checkBox_8"));

        gridLayout_10->addWidget(checkBox_8, 3, 0, 1, 1);

        horizontalLayout_9 = new QHBoxLayout();
        horizontalLayout_9->setObjectName(QString::fromUtf8("horizontalLayout_9"));
        spinBox_2 = new QSpinBox(Storage);
        ...
        horizontalSlider_2->setMaximum(365);
        ...
        DebugLog_2 = new QCheckBox(groupBox_11);
        DebugLog_2->setObjectName(QString::fromUtf8("DebugLog_2"));
        DebugLog_2->setChecked(true);

        gridLayout_14->addWidget(DebugLog_2, 1, 0, 1, 2);
        ...
        gridLayout_14->addWidget(horizontalSlider_3, 3, 1, 1, 1);
        ...
        gridLayout_14->addWidget(spinBox_3, 3, 0, 1, 1);
        ...
        QWidget::setTabOrder(ShortLink_checkBox, comboBox_3);
        QWidget::setTabOrder(comboBox_3, Resulting_checkBox);
        ...
        QWidget::setTabOrder(Hearbeat_checkBox, comboBox_4);
        QWidget::setTabOrder(comboBox_4, Ftp);
        ...
        QWidget::setTabOrder(FtpLocal, checkBox_3);
        QWidget::setTabOrder(checkBox_3, InfoLog);
        QWidget::setTabOrder(InfoLog, DebugLog_2);
        QWidget::setTabOrder(DebugLog_2, DebugLog);
        ...
        QObject::connect(checkBox_4, SIGNAL(clicked(bool)), spinBox, SLOT(setEnabled(bool)));
        QObject::connect(checkBox_4, SIGNAL(clicked(bool)), horizontalSlider, SLOT(setEnabled(bool)));
        QObject::connect(checkBox_8, SIGNAL(clicked(bool)), spinBox_2, SLOT(setEnabled(bool)));
        QObject::connect(checkBox_8, SIGNAL(clicked(bool)), horizontalSlider_2, SLOT(setEnabled(bool)));
...
"More than pair of:One service corresponds to all channels, and only the server mode can be set, One service corresponds to all channels (Need to respond to channel instruction [L|Number])", nullptr));
        ...
        checkBox_3->setText(QApplication::translate("System_Setting_Form", "The main interface shows the storage space", nullptr));
        checkBox_4->setText(QApplication::translate("System_Setting_Form", "Storage space monitoring", nullptr));
        ...
        spinBox->setSuffix(QApplication::translate("System_Setting_Form", "%", nullptr));
        ...
        checkBox_8->setText(QApplication::translate("System_Setting_Form", "Days to save image", nullptr));
        spinBox_2->setSuffix(QApplication::translate("System_Setting_Form", " Day", nullptr));
        ...
        DebugLog_2->setText(QApplication::translate("System_Setting_Form", "save capture log", nullptr));
        spinBox_3->setSuffix(QApplication::translate("System_Setting_Form", " Day", nullptr));
