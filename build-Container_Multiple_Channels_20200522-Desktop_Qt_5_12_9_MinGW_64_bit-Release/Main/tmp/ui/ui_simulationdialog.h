...
public:
    ...
    void setupUi(QDialog *SimulationDialog)
    {
        ...
        gridLayout_2->addWidget(send_plate_lineEdit, 1, 2, 1, 1);
        ...
        gridLayout_2->addWidget(send_iso_before_lineEdit, 1, 0, 1, 1);
        ...
        gridLayout_2->addWidget(send_iso_after_lineEdit, 1, 1, 1, 1);
        ...
        gridLayout_2->addWidget(send_con_after_lineEdit, 0, 2, 1, 2);
        ...
        gridLayout_2->addWidget(send_con_before_lineEdit, 0, 0, 1, 2);
    ...
    void retranslateUi(QDialog *SimulationDialog)
    {
        ...
        pushButton->setText(QApplication::translate("SimulationDialog", "Send", nullptr));
