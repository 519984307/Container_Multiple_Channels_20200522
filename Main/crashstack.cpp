...
LPCWSTR crashstack::m_szAppName;

LPWSTR crashstack::m_szAppVersion;

LPWSTR crashstack::m_szAppBuildNumber;

WCHAR crashstack::m_szMessageText[MAX_WARNING_MESSAGE_PATH];

LPWSTR crashstack::m_szDumpFilePath;
...
void crashstack::SetVersion(LPCWSTR szVersion)
{
    if(szVersion)
    {
        free(m_szAppVersion);
...
void crashstack::SetBuildNumber(LPCWSTR szBuildNumber)
{
    if(szBuildNumber)
    {
...
void crashstack::SetDumpFilePath(LPCWSTR szFilePath)
{
...
LONG crashstack::TopLevelFilter( struct _EXCEPTION_POINTERS *pExceptionInfo )
{
