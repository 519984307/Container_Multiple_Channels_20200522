#ifndef CAPTUREIMAGES_UNDERLYING_H
#define CAPTUREIMAGES_UNDERLYING_H

#include "captureimages_underlying_global.h"
#include "captureimages_underlying_interface.h"
#include "putcommand.h"

class CAPTUREIMAGES_UNDERLYINGSHARED_EXPORT CaptureImages_underlying:public CaptureImages_underlying_Interface
{
    Q_OBJECT
    Q_INTERFACES(CaptureImages_underlying_Interface)
    Q_PLUGIN_METADATA(IID CaptureImages_underlying_InterfaceIID)

public:
    CaptureImages_underlying(QObject *parent=nullptr);
    ~CaptureImages_underlying()Q_DECL_OVERRIDE;
...
#endif // CAPTUREIMAGES_UNDERLYING_H
